...
writeFileSync(
  new URL("../lib/generated-health.ts", import.meta.url),
  `// Generated by scripts/check-data-store.mjs before every production build.\nexport const dataHealth = ${JSON.stringify(report, null, 2)} as const;\n`,
  "utf8",
);
